...
int main()
{
	...
	cout << "sizeof(32): " << sizeof(int32_t) << "sizeof(size_t) " << sizeof(size_t) << endl;
	cout << "sizeof(boolVector1): " << sizeof(boolVector1) << endl;
	...
	cout << "sizeof(boolVector2): " << sizeof(boolVector2) << endl;
